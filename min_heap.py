"""
Generates a min heap from given command line input.
"""
...
def main():
    if len(sys.argv) < 2:
        print("Generates a min heap from given command line input")
        print("    Usage: python min_heap.py \"<keys_separated_by_space>\"")
        print("    e.g. python min_heap.py \"1 2 3 4 5 6 7 8 9\"")
        return
    ...
    graph.render("min_heap", view=True)
